...
import type { NewRoundBody, UpdateRoundBody } from '@/features/practiceRound/practiceRound.schemas.js'
...
export const updatePracticeRoundController: RequestHandler<
    ParamsDictionary,
    PracticeRound,
    UpdateRoundBody
> = async (req, res) => {
    ...
    const supabase = (req as AuthenticatedRequest).supabaseAsUser;
    const round = await updatePracticeRoundWithReturn(supabase, req.body);
